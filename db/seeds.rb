...
# レディース
lady = CategoryAncestry.create(name: "レディース")
...
# メンズ
men = CategoryAncestry.create(name: "メンズ")
...
# ベビー・キッズ
baby_kids = CategoryAncestry.create(name: "ベビー・キッズ")
...
# インテリア・住まい・小物
interior_residence_accessory = CategoryAncestry.create(name: "インテリア・住まい・小物")
...
# 本・音楽・ゲーム
book_music_game = CategoryAncestry.create(name: "本・音楽・ゲーム")
...
# おもちゃ・ホビー・グッズ
toy_hobby_goods = CategoryAncestry.create(name: "おもちゃ・ホビー・グッズ")
...
# コスメ・香水・美容
cosme_perfume_beauty = CategoryAncestry.create(name: "コスメ・香水・美容")
...
# 家電・スマホ・カメラ
appliance_smartphone_camera = CategoryAncestry.create(name: "家電・スマホ・カメラ")
...
# スポーツ・レジャー
sport_leisure = CategoryAncestry.create(name: "スポーツ・レジャー")
...
# ハンドメイド
handmade = CategoryAncestry.create(name: "ハンドメイド")
...
# チケット
ticket = CategoryAncestry.create(name: "チケット")
...
# 自動車・オートバイ
car_motorcycle = CategoryAncestry.create(name: "自動車・オートバイ")
...
# その他
others = CategoryAncestry.create(name: "その他")
